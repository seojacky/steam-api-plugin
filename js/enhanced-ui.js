  ...
  userInfo.innerHTML = `
    <div class="card-body">
      ...
      <dl class="row">
        ...
        <dd>${data.achievementPercentage === 'private' ? i18n.privateProfile : `${data.achievementPercentage}%`}</dd>
      </dl>
      
      <!-- Recently played games section -->
      <h4 class="section-title">${i18n.recentlyPlayed} (${data.recentGamesCount})</h4>
      ${formatRecentGames()}
